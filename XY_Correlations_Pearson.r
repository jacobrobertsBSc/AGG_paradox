...
pdf("ProtFCC vs TransFCC (Pearson).pdf", width = 10, height = 5)
...
pdf("ProtFCC vs Trans (Pearson).pdf", width = 10, height = 5)
...
pdf("Trans vs TransFCC (Pearson).pdf", width = 10, height = 5)
