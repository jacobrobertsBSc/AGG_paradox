...
data = read.csv("Osterman_log_odds.csv", h = TRUE)

pdf("figure_4A.pdf", width = 10, height = 5) #Creating a blank PDF file
fig9 = ggplot(data, aes(x = Codon, y = Log_Odds)) + #Creating a ggplot with the log odds assigned to the Y axis and the codons on the X 
